...
#define VINVALID RSP_BUILD_OP(VINVALID, VINVALID, INFO1(VECTOR))
#define VMACF RSP_BUILD_OP(VMACF, VMACF, INFO3(VECTOR, NEEDVS, NEEDVT))
#define VMACQ RSP_BUILD_OP(VMACQ, VINVALID, INFO1(VECTOR))
#define VMACU RSP_BUILD_OP(VMACU, VMACU, INFO3(VECTOR, NEEDVS, NEEDVT))
...
#define VMULU RSP_BUILD_OP(VMULU, VMULU, INFO3(VECTOR, NEEDVS, NEEDVT))

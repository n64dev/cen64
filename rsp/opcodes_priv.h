...
#define VMADH RSP_BUILD_OP(VMADH, VINVALID, INFO1(VECTOR))
#define VMADL RSP_BUILD_OP(VMADL, VINVALID, INFO1(VECTOR))
#define VMADM RSP_BUILD_OP(VMADM, VINVALID, INFO1(VECTOR))
...
#define VMUDH RSP_BUILD_OP(VMUDH, VINVALID, INFO1(VECTOR))

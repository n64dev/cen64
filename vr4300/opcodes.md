...
#define VR4300_OPCODE_TABLE X(INVALID) \
  ...
  X(DSRA32) X(DSRL) X(DSRLV) X(DSRL32) X(DSUB) X(DSUBU) X(ERET) X(FPUD) \
  X(FPUL) X(FPUS) X(FPUW) X(J) X(JAL) X(JALR) X(JR) X(LB) X(LBU) X(LD) \
  X(LDC0) X(LDC1) X(LDC2) X(LDL) X(LDR) X(LH) X(LHU) X(LL) X(LLD) X(LUI) \
  X(LW) X(LWC0) X(LWC1) X(LWC2) X(LWL) X(LWR) X(LWU) X(MFC0) X(MFC1) \
  X(MFC2) X(MFHI) X(MFLO) X(MTC0) X(MTC1) X(MTC2) X(MTHI) X(MTLO) X(MULT) \
  ...
  X(TGEI) X(TGEIU) X(TGEU) X(TLBP) X(TLBR) X(TLBWI) X(TLBWR) X(TLT) \
  X(TLTI) X(TLTIU) X(TLTU) X(TNE) X(TNEI) X(XOR) X(XORI)
#endif
